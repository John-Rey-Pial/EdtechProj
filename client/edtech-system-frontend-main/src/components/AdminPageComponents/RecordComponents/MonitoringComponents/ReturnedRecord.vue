	...
	<div class="releaseCodeForm">
		<v-card>
			<form action="" @submit.prevent="validate">
				<v-card-text>
					<h2 class="green--text">Receive Form</h2>
					<br />
					...
					<div class="inputs">
						...
						<div class="btnActions">
							<v-btn color="success" type="submit">Receive</v-btn>
						</div>

						<v-dialog hide-overlay persistent width="300" v-model="dialog2">
							<v-card color="white" light>
								<v-card-text>
									<p mt-5>Receiving Record. Please wait</p>
									<v-progress-linear
										indeterminate
										color="black"
										class="mb-0 mt-5"
			...
			async validate() {
				try {
					this.updatedRecord = {
						...
						releaser_name: this.receiverName,
						releaser_code: this.receiverCode,
					};
